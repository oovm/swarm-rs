...
// CRC-32/ISO-HDLC of the grammar file: e8e7f6da
// Any changes to it will be lost on regeneration

#[derive(Debug, Clone)]
pub struct SwarmParser {
    pub statements: Vec<SwarmStatements>,
}
    ...
    mod SwarmParser_impl {
        ...
        mod part_0 {
            ...
            pub fn parse<'a, TT: ParseTracer>(
                ...
                let mut state = state;
                let mut statements: Vec<SwarmStatements> = Vec::new();
                loop {
            ...
            pub type Parsed = Vec<SwarmStatements>;
        }
        #[inline(always)]
        pub fn parse<'a, TT: ParseTracer>(
            state: ParseState<'a>,
